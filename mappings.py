...
VERBAL_INFL_RULES = {
    ...
    '_Freq/V': ['Aspect=Freq'],             # "-O?gAt" gyakorítóképző
...
NOMINAL_INFL_RULES = {
    ...
    '_AdvPtcp/Adv': ['VerbForm=Trans'],               # "-vA" határozói igenév
    ...
    'Temp': ['Case=Tem'],
    'Loc': ['Case=Loc'],
    'Inl': ['Case=Inl'],                                 # TODO ilyen a honlapon nincs, de a tesztanyagban mégis lett
    'Transl': ['Case=Tra'],
    'Ess': ['Case=Ess'],
